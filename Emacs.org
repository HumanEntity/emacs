...
#+RESULTS:
| toc-org-enable | org-tempo-setup | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-fold-show-all append local] 5] | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-babel-show-result-all append local] 5] | org-babel-result-hide-spec | org-babel-hide-all-hashes | rune/org-mode-visual-fill | org-bullets-mode | rune/org-mode-setup | (lambda nil (add-hook 'after-save-hook #'rune/org-babel-tangle-config)) | rune/prettify-org-set | (lambda nil (display-line-numbers-mode 0)) |
